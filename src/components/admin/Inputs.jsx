...
const InputsAdmin = () => {
  ...
  const { editMode, currentAffiliate, cancelEdit: contextCancelEdit } = useContext(AffiliateContext);
  
  // Enhanced cancelEdit function to clear form fields
  const cancelEdit = () => {
    // Reset form fields
    setInputValues({
      password: "",
    ...
    // Call the original cancelEdit from context
    contextCancelEdit();
  };
